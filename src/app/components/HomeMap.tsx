...
import {
  ...
  Flame, UtensilsCrossed, Trophy, PlugZap, ParkingCircle, MoreHorizontal, TrendingUp, Sparkles
} from "lucide-react";
      ...
      <div className="hidden md:grid h-full grid-cols-[420px_1fr] gap-6 p-8">
        ...
        <div className="flex flex-col gap-6 overflow-hidden">
          ...
          <div className="bg-white/90 rounded-[2rem] p-5 shadow-[0_8px_30px_rgba(0,0,0,0.08)] backdrop-blur-xl border border-white/50 flex flex-col gap-4 shrink-0">
            ...
            <ServiceGrid activeFilter={activeFilter} setActiveFilter={setActiveFilter} />
          </div>
...
function ServiceGrid({ activeFilter, setActiveFilter }: { activeFilter: string | null; setActiveFilter: (f: string | null) => void }) {
  return (
